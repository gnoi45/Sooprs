        ...
        <div class="container-lg">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <form action="{{ route('post.edit.service') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group mt-2 mb-2">
                                    ...
                                    <select class="form-control" name="cat_id" id="">
                                        ...
                                        @foreach($allServices as $item)
                                            ...
                                            <option value="{{ $item->id }}" {{ $service->cat_id == $item->id ? 'selected':'' }}>{{ $item->service_name }}</option>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group mt-2 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="service_slug" value="{{ $service->service_slug }}">
                            ...
                            {{-- <div class="col-md-12">
                                ...
                                <div class="form-group mt-2 mb-2">
                                    ...
                                    <textarea name="service_desc" class="form-control" id="ser_st" cols="30" rows="10">{!! $service->service_desc !!}</textarea>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group mt-2 mb-2">
                                    ...
                                    <textarea name="service_desc" class="full-featured-non-premium">{!! $service->service_desc !!}</textarea>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group mt-2 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="service_bg_img" value="{{ $service->service_bg_img }}">



                                    <img class="mt-3" src="{{ $service->service_bg_img }}" alt="service-image" style="width:70px">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group mt-2 mb-2">
                                    ...
                                    <label for="#ser_st">Service banner strip image</label>



                                    {{-- <input type="file" class="form-control" name="banner_strip"> --}}

                                    <input type="text" class="form-control" name="banner_strip" value="{{ $service->banner_strip }}">



                                    <!-- <img class="mt-3" src="{{ $service->banner_strip }}" alt="service-image" style="width:70px"> -->
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group mt-3 mb-2">
                                    ...
                                    <select class="selectpicker form-control" multiple data-live-search="true" id="services" name="sr_home[]" required>
                                        ...
                                        <option value="{{ $one->id }}" @if(in_array($one->id,$allChildServicesArr))

                                            selected

                                            @endif>{{ $one->service_name }}</option>
                        ...
                        <button type="submit" class="button-21 btn ">Save</button>
