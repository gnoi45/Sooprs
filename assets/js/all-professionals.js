...
function pagination_scroll(offsett, limitt) {
    $.ajax({
        ...
        method: "POST",
        cache: false,
        data: { offset: offsett, limit: limitt },
                   ...
                   var skillsParagraph = document.createElement('p');
                                                ...
                                                <div class='row mt-3 align-items-center'>\
                                                    <div class='col-md-12 col-sm-12 d-flex justify-content-between'  style=' align-items: baseline;'>\
                                                        ...
                                                        <div class='col-md-6 col-sm-6' style=' text-align: end;'>\
                                                            <a href='professional/"+ item['data']['slug'] + "'><button class='mt-2 view-prof-btn'><i class='fa-solid fa-arrow-right text-primary'></i></button></a>\
                                                        </div>\
                                                    </div>\
                                                </div>\
                                            </div>\
                    ...
                    htmlContent2 += "<div class='col-md-4 col-sm-12 mt-3  '>\
                                        <div class='text-center  bg-light' style=' padding: 15px;    border-radius: 10px; position:relative;   height: 100%;box-shadow: 0px 0px 7px -3px black;'>\
                                            ...
                                            <a href='professional/"+ item['data']['slug'] + "' style='position: absolute; right: 10px;bottom: 10px;'>\
                                                ...
                                                <div class='list-right-box'>\
                                                    ...
                                                    <div class='row mt-3 align-items-center'>\
                                                        <div class='col-md-12 col-sm-12 d-flex justify-content-between'  style=' align-items: baseline;'>\
                                                            ...
                                                            <div class='col-md-6 col-sm-6' style=' text-align: end;'>\
                                                                <a href='professional/"+ item['data']['slug'] + "'><button class='mt-2 view-prof-btn'><i class='fa-solid fa-arrow-right text-primary' style='color: #ffffff;'></i></button></a>\
                                                            </div>\
                                                        </div>\
                                                    </div>\
                                                </div>\
