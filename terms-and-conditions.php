...
$title = 'Terms & Conditions | Sooprs.com';
...
<style>
    ...
    .about-section-top::before {
        content: "";
        background-image: url('https://res.cloudinary.com/dr4iluda9/image/upload/v1709885456/terms_g4wgwk.webp');
        background-repeat: no-repeat;
...
<section class="about-section-top">
    <div class="container">
        <div class="bread-text">
            <p class="d-none d-md-block">Terms and Conditions</p>
            <p class="d-lg-none d-md-none" style="    font-size: 2rem!important;">Terms and Conditions</p>
...
<section class="margin25">
    <div class="container">
        <div class="first-contentbox">
            ...
            <p>Welcome to Sooprs.com!</p>
            <p>These terms and conditions outline the rules and regulations for the use of Sooprs's Website, located at
                <a href="https://www.sooprs.com" target="_blank">https://www.sooprs.com</a>.
            </p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                Sooprs.com if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
                ...
                prevailing law of in. Any use of the above terminology or other words in the singular, plural,
        ...
        <div class="second-contentbox">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <p>We employ the use of cookies. By accessing Sooprs.com, you agreed to use cookies in agreement
                        with the Sooprs's Privacy Policy. </p>
        ...
        <div class="second-contentbox">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <p>Unless otherwise stated, Sooprs and/or its licensors own the intellectual property rights for all
                        material on Sooprs.com. All intellectual property rights are reserved. You may access this from
                        Sooprs.com for your own personal use subjected to restrictions set in these terms and
                        conditions.</p>

                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from Sooprs.com</li>
                        <li>Sell, rent or sub-license material from Sooprs.com</li>
                        <li>Reproduce, duplicate or copy material from Sooprs.com</li>
                        <li>Redistribute content from Sooprs.com</li>
                    </ul>
                    ...
                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                        information in certain areas of the website. Sooprs does not filter, edit, publish or review
                        Comments prior to their presence on the website. Comments do not reflect the views and opinions
                        of Sooprs,its agents and/or affiliates. Comments reflect the views and opinions of the person
                        who post their views and opinions. To the extent permitted by applicable laws, Sooprs shall not
                    ...
                    <p>Sooprs reserves the right to monitor all Comments and to remove any Comments which can be
                    ...
                    <p>You hereby grant Sooprs a non-exclusive license to use, reproduce, edit and authorize others to
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                        ...
                        hyperlink compensates the absence of Sooprs; and (d) the link is in the context of general
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
                        our website, you must inform us by sending an e-mail to Sooprs. Please include your name, your
                    ...
                    <p>No use of Sooprs's logo or other artwork will be allowed for linking absent a trademark license
                        agreement.</p>
                </div>
