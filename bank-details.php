...
<section class="about-section-top">
    <div class="container">
        <div class="bread-text">
            <p class="d-none d-md-block">Settings</p>
            <p class="d-lg-none d-md-none" style="    font-size: 2rem!important;">Settings</p>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-9 col-md-9 col-sm-12 d-flex">
                ...
                <div class="card flex-fill border border-0 "
                    ...
                    <div class="row m-0" style="padding: 20px; background-color: white;">
                        <div class="heading">
                            <p class="fs-5">Add Your Bank Details</p>
                        </div>
                        <div class="col-md-12">
                            <form id="bank-details" action="" method="post" enctype="multipart/form-data"
                                ...
                                <input type="hidden" name="user" id="user" value="<?php echo $username['slug']; ?>">
                                <div class="row">
                                    <input type="hidden" name="id" id="id" value="<?php echo $username['id'] ?>">
                                    <div class=" mt-3 col-md-12 col-sm-12">
                                        <label for="bank_name">Bank Name</label>
                                        <input class="form-control" id="bank_name" type="text" name="name" value="">
                                    </div>
                                    <div class=" mt-3 col-md-12 col-sm-12">
                                        <label for="account_no">Bank Account No.</label>
                                        <input class="form-control" id="account_no" type="text" name="account_no">
                                    </div>
                                    <div class=" mt-3 col-md-12 col-sm-12">
                                        <label for="ifsc">Bank IFSC</label>
                                        <input class="form-control" id="ifsc" type="text"  name="ifsc">
                                    </div>
                                    <div class=" mt-3 text-center col-md-12 col-sm-12">
                                        <button type="button" id="add_bank_details" name="add_bank_details" class="btn  btn-primary btn-sm  col-4 mx-auto rounded-0 " style="">
...
<script>
    $(document).ready(function () {
        ...
        var user = "<?php echo $username['slug'] ?>";
        $.ajax({
                type: "POST",
                url: "<?php echo $SITE_URL ?>/api2/public/index.php/get_bank_details",
                data: {                    
                    user: user,
                },
                cache: false,
                success: function (data) {
                    ...
                    if (new_data.status == 200) {
                        hideLoader();
                        $("#bank_name").val(new_data.msg.bank_name);
                        $("#account_no").val(new_data.msg.account_no);
                        $("#ifsc").val(new_data.msg.ifsc);
        ...
        $("#add_bank_details").click(function () {
            ...
            if (id == '' || bank_name == '' || account_no == '' || ifsc == '') {
                hideLoader();
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $SITE_URL ?>/api2/public/index.php/add_bank_details",
                data: {
                    id: id,
                    bank_name: bank_name,
