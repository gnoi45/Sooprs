...
<section class="about-section-top">
    ...
    <div class="container">
        ...
        <div class="bread-text">
            ...
            <p class="d-none d-md-block">My bids</p>

            <p class="d-lg-none d-md-none" style="    font-size: 2rem!important;">My Bids</p>
...
<section class="top-sectop" style="    background-color: #fff;top:45px;">
    <div class="container pb-5">
        <p class="text-capitalize fs-6" style=" padding: 30px 30px;">
            ...
            &nbsp; <a class="fs-6" href="#" style="text-decoration:none; color: #758599;">My Leads</a>&nbsp;
        </p>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12" style="    padding: 0px 25px;">
                <div class="container">
                    <div class="filter-div pb-4 bg-light"
                        ...
                        <hr>
                        <div class="category-heading  cat-heading-myleads" style=" 12px;">
...
<script src="<?php echo $SITE_URL ?>/assets/js/my-leads.js"></script>
